  ...
  return (
    <div className="flex flex-row h-[7%] sm:h-[8%] md:h-[6%] lg:h-[5%]">
      ...
      <div className="flex relative items-center w-[10%] justify-end hover:cursor-pointer">
        ...
        />
        {dropDownIsOpen && (
          <div className="flex flex-col p-3 text-xs sm:text-sm md:text-base md:p-4 text-center items-center rounded-md border-[1px] border-black bg-white border-opacity-60 absolute top-[90%] -left-[170%] sm:-left-[80%] md:-left-[65%] lg:-left-[40%] xl:-left-[9%] z-40">
            <div className="hover:cursor-pointer hover:font-[500]">
              Manage Account
            </div>
            <div className="hover:cursor-pointer hover:font-[500]">Upload New Recipe</div>
          </div>
        )}
      </div>
    </div>
